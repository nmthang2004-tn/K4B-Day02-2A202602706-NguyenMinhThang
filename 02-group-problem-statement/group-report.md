...
|---|---|---|
| #4 — Tin nhắn nhóm chat bị trôi vì nhiễu | Actor rõ (thành viên nhóm dự án); pain lặp lại hàng ngày, ai trong nhóm cũng từng trải; có thể validate nhanh bằng survey nội bộ | Chưa rõ ranh giới AI được đọc bao nhiêu tin nhắn (privacy); "tiếng ồn" là khái niệm cảm tính, cần định nghĩa lại bằng số liệu |
| #11 — Phân loại mức ưu tiên email công ty (HR/kế toán) | Workflow rõ, có thể đo bằng thời gian đọc/tổng hợp; đã có nhiều sản phẩm tham chiếu (Gmail priority inbox, Copilot for Outlook) | Actor hẹp (chỉ HR/kế toán), khó thu thập dữ liệu email thật để demo trong lab |
| #9 — Tổng hợp tài liệu literature review | Actor và bottleneck rất cụ thể (đọc abstract, loại paper không liên quan); impact đo được bằng thời gian tìm tài liệu | Nhóm không có ai đang làm nghiên cứu học thuật thật để validate sâu; phạm vi hẹp hơn nhu cầu chung của nhóm |
...
*Ghi chú chấm điểm:* #4 được 5 ở "Actor rõ" và "Nhóm hiểu domain" vì cả 6 thành viên đều là actor thật (đang dùng nhóm chat học tập/dự án hằng ngày) nên dễ tự validate và tự dogfood. #9 chỉ được 2 ở "Nhóm hiểu domain" vì không thành viên nào đang làm nghiên cứu học thuật full-time nên khó đánh giá đúng mức độ đau của actor.
...
|---|---:|---|---|---|
| Interview | 3 | Người được phỏng vấn xác nhận thường xuyên phải cuộn ngược lại nhóm chat lớp/dự án để tìm lại thông báo deadline vì tin bị các đoạn chat phiếm đẩy trôi, và từng ít nhất một lần nộp trễ vì không thấy thông báo | Một người cho biết nếu nhóm chat nhỏ (dưới 10 người) và có quy ước rõ ràng (chỉ nhắn việc, bàn tán ở nhóm riêng) thì vấn đề gần như không xảy ra | Nhóm bổ sung boundary: vấn đề rõ nhất ở nhóm chat đông người (>15 người) hoặc nhóm không có quy ước rõ ràng, cần nêu rõ điều kiện này trong Actor/Workflow |
| Survey / poll | 6 | 5/6 người xác nhận từng bỏ lỡ thông báo hoặc task quan trọng vì tin nhắn bị trôi trong nhóm chat đông người, tần suất trung bình 2-3 lần/tuần | 1/6 người cho biết ít gặp vấn đề vì đã có thói quen ghim (pin) tin nhắn quan trọng | Nhóm giữ nguyên bài toán nhưng làm rõ Success Metric cần đo cả tần suất bỏ lỡ trước/sau, không chỉ thời gian xử lý |
| Log / ticket / review (nếu có) | — | Chưa thu thập được do nhóm chat cá nhân không xuất được log định lượng trong thời gian làm lab | — | Chưa cần sửa problem; ghi nhận đây là giới hạn của validation, sẽ bổ sung nếu có thời gian pilot thật |
...
|---|---|---|---|---|---|
| Slack AI — Channel/Thread Summaries & Daily Recap | https://slack.com/blog/productivity/ai-summarization-a-guide-to-conquering-information-overload | Bước đọc và tóm tắt lại tin nhắn đã bỏ lỡ trong 1 channel/thread, gửi digest buổi sáng theo các channel người dùng chọn theo dõi | Tóm tắt có kèm trích dẫn (citation) link tới tin gốc để kiểm tra lại ngữ cảnh; hỗ trợ tóm tắt theo khung thời gian tùy chọn | Chỉ tóm tắt, không tự phân loại mức ưu tiên hay đề xuất người cần tag/xử lý; là tính năng trả phí, chỉ có ở gói Business+ trở lên | Nhóm nên tách rõ 2 việc: "tóm tắt nội dung đã bỏ lỡ" (Slack đã làm tốt) và "gợi ý ai cần xử lý/tag" (khoảng trống nhóm có thể lấp) |
| Microsoft Teams Copilot — Catch up & Thread Summary | https://support.microsoft.com/en-us/teams/copilot/how-to-use-microsoft-365-copilot-in-teams-chats-and-channels | Cho phép hỏi "Summarize what I've missed" trong chat/channel để lấy lại các điểm chính đã bỏ lỡ, tóm tắt theo thread | Tích hợp sẵn trong hệ sinh thái Microsoft 365, có thể hỏi bằng ngôn ngữ tự nhiên, tham chiếu lịch sử 30 ngày | Yêu cầu thread đủ dài (tối thiểu ~1000 ký tự) mới tóm tắt được; không phân biệt được tin "khẩn" cần phản hồi ngay với tin chỉ để biết | Nhóm cần bổ sung cơ chế "mức độ khẩn/priority" và cơ chế đẩy thông báo chủ động, thay vì chỉ chờ người dùng chủ động hỏi |
| Discord (không có AI tóm tắt tích hợp sẵn) | https://discord.com | Chỉ giải quyết được việc phân luồng nội dung bằng nhiều channel/thread thủ công, không có tóm tắt hay ưu tiên tự động | Miễn phí, quen thuộc với nhiều sinh viên, dễ tạo nhiều channel theo chủ đề | Người dùng vẫn phải tự đọc lướt toàn bộ channel để không bỏ sót; đây chính là khoảng trống thị trường cho candidate #4 | Nếu nhóm nhắm tới actor là sinh viên/nhóm dự án dùng Discord/Zalo, đây là thị trường chưa có giải pháp AI tích hợp sẵn — cơ hội để build thêm lớp tóm tắt + gợi ý tag |
...
```text
[1 Mở app nhận tin: liên tục] → [2 Đọc lướt từng tin: 5-30s/tin] → [3 Phân loại/ưu tiên thủ công: vài giây-vài phút] → [4 Đánh dấu/ghi nhớ tin quan trọng: khi cần] → [5 Tạo task/nhắc việc thủ công: theo deadline - handoff] → [6 Theo dõi tin mới liên tục: cả ngày - bottleneck] → [7 Rà soát cuối ngày: cuối ngày - bottleneck]
```
...
| 6 | Người dùng theo dõi các tin nhắn mới trong lúc làm việc | Tin nhắn mới liên tục xuất hiện | Danh sách tin cập nhật | Liên tục trong ngày | Tin mới nhanh chóng đẩy tin cũ lên trên, làm giảm khả năng nhìn thấy thông tin quan trọng |
...
```text
[1 Gom luồng & lọc tự động: liên tục - Rule/máy] → [2 AI phân tích & tóm tắt ngữ cảnh, gắn nhãn ưu tiên: <1s/tin - AI] → [3 Người dùng phê duyệt/ra quyết định trên digest: 2-3 lần/ngày - Human review/boundary] → [4 AI đồng bộ task & phản hồi (Jira/Trello, gửi tin): tức thì sau khi duyệt - AI] → [5 Chế độ "gác cổng" khi deep work, chỉ đẩy tin khẩn: xuyên suốt - AI] → [6 Rà soát cuối ngày (Wrap-up): 1 lần/ngày - Human + AI]

Fallback: Nếu AI gắn nhãn/tóm tắt sai hoặc không đủ tin cậy, người dùng luôn có thể mở lại tin nhắn gốc (kèm citation) để tự đọc và xử lý thủ công như cách cũ; mọi task chỉ được tạo/gửi sau khi có Human review ở Bước 3.
```

| Bước | Actor | Input | Output | Thời gian / tần suất | Ghi chú (handoff? bottleneck?) |
|---|---|---|---|---|---|
| 1 | AI Assistant (chạy ngầm) | Dữ liệu thô từ nhiều kênh (Gmail, Zalo, Teams...) | Dữ liệu hội tụ về một Dashboard duy nhất; loại bỏ spam/chat phiếm | Liên tục (real-time) | Giải quyết bottleneck bước 1 & 2 cũ: tự động loại nhiễu, xóa bỏ thao tác chuyển đổi qua lại giữa các app |
| 2 | AI Assistant | Nội dung tin nhắn đã lọc | Gắn nhãn ưu tiên (khẩn/bình thường), trích xuất task, tóm tắt ý chính (1-2 câu) | < 1 giây/tin nhắn | Không còn phụ thuộc vào việc người dùng tự đọc và nhớ; dữ liệu được chuẩn bị sẵn để ra quyết định |
| 3 | Người dùng | Báo cáo tóm tắt (digest) chứa tin quan trọng và task đề xuất | Chấp nhận/chỉnh sửa phản hồi, hoặc duyệt tạo task | 2-3 lần/ngày (sáng, trưa, cuối ngày) | Boundary: người dùng chỉ đóng vai trò "người duyệt" (approver), xem theo lô thay vì bị phân tâm liên tục |
| 4 | AI Assistant | Lệnh duyệt của người dùng | Task tự động đồng bộ vào Jira/Trello; email/tin nhắn tự động gửi đi | Tức thì sau khi duyệt | Seamless handoff: giải quyết điểm nghẽn copy-paste thủ công ở bước 5 cũ |
| 5 | AI Assistant | Tin nhắn mới đến lúc người dùng đang deep work | Thông báo đẩy (push) chỉ với tin khẩn/VIP; các tin khác gom vào lô sau | Xuyên suốt thời gian làm việc | Bảo vệ sự tập trung, khắc phục tình trạng "tin mới đẩy tin cũ" |
| 6 | Người dùng + AI Assistant | Toàn bộ lịch sử trong ngày | Báo cáo tổng kết: việc đã xử lý, người chưa phản hồi, việc dời sang ngày mai | 1 lần/ngày (vài phút trước khi nghỉ) | Giải quyết bottleneck bước 7 cũ: giảm rủi ro bỏ sót hay quên lãng |

**Before/after impact:**

| Metric | Trước | Sau kỳ vọng | Cách đo |
|---|---:|---:|---|
| Tổng thời gian | 2-3 giờ/ngày (bị phân mảnh, rải rác suốt ngày làm việc) | 30-45 phút/ngày (xử lý tập trung theo 2-3 lô cố định) | Đo bằng công cụ theo dõi thời gian sử dụng app (RescueTime, Toggl) hoặc thời gian phản hồi trung bình |
| Số bước | 7 bước | 6 bước | Đếm trực tiếp số công đoạn (node) trên flowchart |
| Số bước thủ công | 7/7 bước | 2/6 bước (chỉ còn bước 3: phê duyệt và bước 6: rà soát cuối ngày) | Tỷ lệ số bước yêu cầu con người thao tác trực tiếp trên tổng số bước |
| Bottleneck chính | Rà soát tìm tin nhắn cũ/tin rác; handoff chuyển tin thành task chậm | AI cần thời gian "học" thói quen phân loại; khó xử lý tin quá phức tạp/đa nghĩa | Đánh giá qua số đầu việc trễ hạn (missed SLA); khảo sát cảm nhận quá tải |
| Risk mới | Bỏ sót thông tin do quá tải, quên đánh dấu, trôi tin | AI tóm tắt sai ngữ cảnh (hallucination); lọc nhầm tin quan trọng thành rác (false negative); rủi ro bảo mật khi AI đọc tin nhắn | Số lần phải sửa lại bản tóm tắt của AI; audit ngẫu nhiên thùng rác để đếm tin lọc nhầm; đánh giá uptime server AI |
...
- Field nào mơ hồ: "Impact" mới nêu ảnh hưởng chung chung (giảm hiệu suất, ảnh hưởng uy tín) mà chưa gắn với con số cụ thể; "Boundary" chưa nói rõ AI được phép đọc dữ liệu ở mức nào (toàn bộ lịch sử chat hay chỉ tin mới) để đảm bảo quyền riêng tư.
- Tôi sửa gì: Ở v1, nhóm thu hẹp phạm vi Impact/Boundary vào đúng 1 tác vụ cụ thể (gợi ý tag đúng người phụ trách) thay vì toàn bộ vòng đời tin nhắn, đồng thời thêm rõ AI chỉ đọc tin trong phạm vi channel/nhóm mà người dùng đã cấp quyền.
...
- Độ mơ hồ: [x] Cao (nhiều cách trả lời vẫn OK) — Vì sao: Nhận diện đúng người cần tag phụ thuộc vào ngữ cảnh tin nhắn tự nhiên và tiến độ công việc thực tế của dự án, không có một đáp án đúng/sai tuyệt đối.
- Độ phức tạp: [x] Cao (3+ bước/nguồn, phụ thuộc nhau) — Vì sao: Cần truy xuất và tổng hợp thông tin từ nhiều nguồn (context dự án, danh sách thành viên, lịch sử trao đổi) rồi mới suy luận ra được người phù hợp.
...
```text
Bài toán yêu cầu khả năng truy vấn đa nguồn tự động (fetch context) và phân tích ngữ cảnh tự nhiên để đưa ra gợi ý chính xác, thay vì chỉ áp một luật cố định.
```
...
|---|---|---|---|---|
| **Rule** | Phân loại theo từ khóa/phòng ban cố định | Dự án đơn giản, luồng cố định | Không bắt được ngữ cảnh linh hoạt | Không |
| **Workflow** | Quy trình tuyến tính từng bước (lọc → tóm tắt → gửi digest → chờ duyệt) | Luồng xử lý định sẵn, ít rẽ nhánh | Thiếu khả năng tự động truy vấn context động | Dùng làm khung quy trình tổng thể (bước 1, 4, 5, 6) |
| **Agent** | Tự động fetch context dự án, suy luận người liên quan và đề xuất tag | Ngữ cảnh phức tạp, dữ liệu đa nguồn | Có thể gợi ý sai người | Giải pháp chính cho bước 2 & 3 (phân tích ngữ cảnh và gợi ý tag) |

**5 câu hỏi chốt (trả lời câu đầy đủ):**
1. Rule có giải được 70-80% case không? Không, vì trao đổi trong dự án rất đa dạng và biến động, một bộ từ khóa cố định không bắt được hết ngữ cảnh.
2. Các bước có đi thẳng một đường không hay phải rẽ nhánh? Có rẽ nhánh tùy thuộc vào kết quả fetch context (tìm được người phụ trách rõ ràng hay không).
3. Có thật sự cần Agent tự lập kế hoạch + gọi tool không? Có, cần Agent tự gọi tool fetch context dự án và thông tin thành viên trước khi đưa ra gợi ý.
4. Nếu AI sai, ai phát hiện đầu tiên và sửa trong bao lâu? Người dùng phát hiện ngay tại bước Human Review (mất khoảng 1 phút) trước khi tin được gửi hoặc task được tạo.
5. Có hạ được từ Agent → Workflow → Rule không? Có thể hạ xuống Workflow nếu dữ liệu context (danh sách thành viên, phân công) đã được chuẩn hóa sẵn.
...
| **Success Metric** | Tỷ lệ tag đúng người ≥ 85%, tổng thời gian xử lý giảm xuống còn 3 phút/tin nhắn. |
| **Boundary** (làm / không làm) | Hệ thống chỉ fetch context và gợi ý tag; không tự động gửi tin nhắn hay tag khi chưa có sự phê duyệt của người dùng. |
| **AI intervention point** (can thiệp sau bước nào, trước bước nào) | Bắt đầu sau Bước 1 (khi tin nhắn được khởi tạo) và kết thúc trước Bước 4 (trước khi người dùng phê duyệt). |
| **Mức chọn** (Rule / Workflow / Agent + 1 câu vì sao) | Agent — vì cần fetch context linh hoạt và suy luận ngữ cảnh mà Rule/Workflow không đáp ứng được. |
| **Rủi ro & người thật kiểm tra** (rủi ro lớn nhất + ai kiểm tra bằng cách nào) | Rủi ro lớn nhất là gợi ý sai người; người dùng (Human-in-the-loop) trực tiếp kiểm tra và chọn tag ở Bước 4 trước khi gửi. |

### 6.3. Final decision

| Câu hỏi | Yes / Not Yet / No | Ghi chú (câu đầy đủ) |
|---|---|---|
| Actor + workflow rõ chưa? | Yes | Đã xác định rõ actor và 4 bước chi tiết trong workflow tương lai. |
| Baseline + metric đo được chưa? | Yes | Baseline ước tính 5-10 phút/lần xử lý, metric kỳ vọng 3 phút và độ chính xác tag ≥ 85%. |
| Data/input đủ dùng chưa? | Yes | Có thể dùng lịch sử chat, context dự án và danh sách thành viên trong lab để thử nghiệm. |
| AI sai, hậu quả chấp nhận được không? | Yes | Có bước Human Review duyệt trước khi bất kỳ tag/task nào được gửi thật. |
| Có người review/owner không? | Yes | Người gửi tin nhắn (hoặc trưởng nhóm) trực tiếp review gợi ý của Agent. |
| Có cách non-AI đơn giản hơn không? | Not Yet | Rule cứng (từ khóa/phòng ban) không xử lý được ngữ cảnh linh hoạt của dự án thực tế, nên nhóm chưa tìm được phương án non-AI đủ tốt. |
...
```text
Bài toán rõ ràng, đã được validate qua interview và survey nội bộ (5/6 người xác nhận từng bỏ lỡ thông tin vì trôi tin nhắn). Thiết kế workflow chặt chẽ với sự kết hợp Agent (fetch context, gợi ý) + Human-in-the-loop (review, duyệt) đảm bảo an toàn và hiệu quả, đồng thời khoảng trống này chưa được các nền tảng phổ biến (Discord, Zalo) giải quyết trực tiếp.
```

**Nếu Go — pilot nhỏ nhất (data nào, chạy tay ra sao, đo 3 số nào):**

```text
Thử nghiệm trên 1 nhóm dự án thật (5-10 người), chạy tay/bán tự động trên 50 tin nhắn công việc thực tế. Đo 3 chỉ số: tỷ lệ gợi ý tag đúng người, thời gian xử lý trung bình mỗi tin, và số lần người dùng phải chỉnh sửa gợi ý của Agent.
```

**Nếu Not Yet — cần validate gì trước:**

```text
(Không áp dụng — nhóm đã quyết định Go)
```
...
```text
Nếu độ chính xác gợi ý tag dưới 60% hoặc thời gian review kéo dài hơn baseline thủ công, nhóm sẽ rollback về Workflow đơn giản hơn (gợi ý theo phân công cố định/từ khóa) thay vì tiếp tục dùng Agent.
```
